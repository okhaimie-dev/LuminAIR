...
Ensure all [tests](https://github.com/raphaelDkhn/LuminAir/blob/master/zkVMs/cairo/src/tests/ops.rs) pass for primitive operations to verify compatibility and functionality.
...
<AccordionGroup>
    <Accordion title="1. Create a New Directory">
      ...
      - Create a new folder for your zkVM, e.g., `zkVMs/myZkVM`.
    </Accordion>
    ...
    <Accordion title="4. Ensure Compliance">
        ...
        - Implement tests similar to those found [here](https://github.com/raphaelDkhn/LuminAir/blob/master/zkVMs/cairo/src/tests/ops.rs) to ensure compatibility.
    </Accordion>
